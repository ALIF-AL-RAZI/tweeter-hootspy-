...
export default function ThemeRoutes() {
    ...
    const authCommonRoutes = [
        // { path: '/campaign/new', element: <Navigate to={routeStr} replace /> },
        { path: '/record/:id', element: <Navigate to={routeStr} replace /> },
        { path: '/records', element: <Navigate to={routeStr} replace /> },
        { path: '/get-code', element: <Navigate to={routeStr} replace /> },
