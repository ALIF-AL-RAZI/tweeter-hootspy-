...
const RegisterWithOTP = () => {
    ...
    const handleOPTSubmit = async (e) => {
        ...
        axios
            .post(`${TweetsyConfig.getNodeUrl()}api/v1/otp/verify-otp`, {
                OTP: OTPValue,
    ...
    const sendOTPAtEmail = async ({ name, ...rest }) => {
        ...
        setSendingOTP(true);
        axios
            .post(`${TweetsyConfig.getNodeUrl()}api/v1/email/send-otp-email`, { name: userObject.name, email: userObject.email })
            .then(({ data }) => {
