    ...
    return (
        <MainCard sx={{ minHeight: '100%', position: 'relative' }}>
                ...
                <Box>
                    ...
                    >
                        <Box style={{ height: '100%' }}>
                            ...
                            <Button variant="contained" size="small" sx={{ mt: 2 }} onClick={() => setIsConfirmOpen(true)}>
                                Cancel subscription
                            </Button>
                        </Box>
                    </Box>
            ...
            <Dialog open={isConfirmOpen} onClose={() => setIsConfirmOpen(false)}>
                ...
                <DialogContent>
                    <DialogContentText>Please email hey@tweetsy.io with the reason for unsubscribing</DialogContentText>
                </DialogContent>
